...
- **THEN** the system keeps the user in the form, shows field-level or form-level feedback using the shared validation pattern, does not create a purchase, and does not consume a purchase code for validation failures
