...
- **WHEN** una persona sin sesión abre `/compras/PUR-0003` y luego inicia sesión correctamente
- **THEN** el sistema la lleva a `/compras/PUR-0003`
...
- **WHEN** un usuario con rol `lectura` invoca directamente la operación que anula una compra, evitando la interfaz
